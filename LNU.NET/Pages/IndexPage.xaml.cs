    ...
    public sealed partial class IndexPage : Page {
        ...
        internal static class InsideMapHelper {
            ...
            static private List<AdaptiveItem> indexResources = new List<AdaptiveItem> {
                ...
                new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xEE93),
                    ItemTitle =GetUIString("LNU_Index_SCH"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://jwgl.lnu.edu.cn/oa/xl2016-2017-1.jpg"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 210, 67, 72)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/24.jpg"),
                } ,
                 new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xEC07),
                    ItemTitle =GetUIString("LNU_Index_TOOTATU"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://jwgl.lnu.edu.cn/oa/jxdw.html"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 49, 155, 88)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/25.jpg"),
                } ,
                 new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xE1D3),
                    ItemTitle =GetUIString("LNU_Index_LL"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://library.lnu.edu.cn/"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 213, 131, 67)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/23.jpg"),
                } ,
                 new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xE890),
                    ItemTitle =GetUIString("LNU_Index_Weibo"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://weibo.com/liaoninguniversity?refer_flag=1001030101_"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 213, 162, 67)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/21.jpg"),
                } ,
                 new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xE7BE),
                    ItemTitle =GetUIString("LNU_Index_SH"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://www.studyinlnu.com/"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 61, 66, 148)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/22.jpg"),
                } ,
                new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xEA8C),
                    ItemTitle =GetUIString("LNU_Index_SW"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://xsc.lnu.edu.cn/"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 4, 168, 118)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/18.jpg"),
                } ,
                new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xE909),
                    ItemTitle =GetUIString("LNU_Index_UAN"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://zs.lnu.edu.cn/webs/index.asp"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 16, 85, 162)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/19.jpg"),
                } ,
                 new AdaptiveItem {
                    ItemIcon = char.ConvertFromUtf32(0xE815),
                    ItemTitle =GetUIString("LUN_Index_EIN"),
                    Description = null,
                    NaviType = NavigateType.Webview,
                    PathUri = new Uri("http://job.lnu.edu.cn/"),
                    Background = new SolidColorBrush(Color.FromArgb(255, 211, 67, 71)),
                    IconForeground = new SolidColorBrush(Colors.White),
                    TitleForeground = new SolidColorBrush(Colors.White),
                    BackImage = new Uri("ms-appx:///Assets/20.jpg"),
                } ,
            };
            #endregion
